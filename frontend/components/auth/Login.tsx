        ...
        <div className="flex items-center justify-center min-h-[60vh] animate-in fade-in zoom-in duration-500">
            <Card className="w-full max-w-md bg-black border-white/5 shadow-2xl overflow-hidden relative">
                ...
                <CardHeader className="space-y-1 pb-8">
                    <CardTitle className="text-3xl font-black text-white tracking-tighter">Member Access</CardTitle>
                ...
                <CardContent className="space-y-6">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-white tracking-widest pl-1" htmlFor="password">Password</label>
                            <div className="relative group">
