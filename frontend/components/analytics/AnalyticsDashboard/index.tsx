    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-4xl font-black text-white tracking-tighter uppercase">Squad Intelligence</h1>
                    <p className="text-white/40 text-sm font-bold uppercase tracking-widest">Advanced AI Match Analytics</p>
                </div>
                <div className="flex gap-3 items-center">
                    <div className="glass px-4 py-2 rounded-xl flex items-center gap-2 border-[#006747]/20 bg-[#006747]/5">
                        ...
                        <span className="text-[10px] font-black text-white uppercase tracking-widest">Live Analysis Active</span>
                    </div>
                </div>
            </div>
            ...
            <Tabs defaultValue="shooting" className="w-full" onValueChange={setActiveTab}>
                <TabsList className="bg-black border border-white/10 p-1.5 mb-8 shadow-2xl rounded-2xl">
                    <TabsTrigger value="shooting" className="px-8 py-3 data-[state=active]:bg-[#006747] data-[state=active]:text-white transition-all rounded-xl font-black uppercase text-[10px] tracking-widest border border-transparent data-[state=active]:border-white/10">
                        <Target className="w-4 h-4 mr-2" /> Shooting
                    </TabsTrigger>
                    <TabsTrigger value="substitution" className="px-8 py-3 data-[state=active]:bg-red-700 data-[state=active]:text-white transition-all rounded-xl font-black uppercase text-[10px] tracking-widest border border-transparent data-[state=active]:border-white/10">
                        <UserMinus className="w-4 h-4 mr-2" /> Substitutions
                    </TabsTrigger>
                    <TabsTrigger value="disciplinary" className="px-8 py-3 data-[state=active]:bg-[#006747] data-[state=active]:text-white transition-all rounded-xl font-black uppercase text-[10px] tracking-widest border border-transparent data-[state=active]:border-white/10">
                        ...
                        <div className="space-y-6">
                            <Card className="glass border-white/5 h-full bg-black/40">
                                <CardHeader className="border-b border-white/5 pb-4">
                                    <CardTitle className="text-xs font-black text-white uppercase tracking-widest">Shooting Intelligence</CardTitle>
                                    <CardDescription className="text-[10px] font-bold text-white/30 uppercase tracking-tighter">AI-detected precision trends</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4 pt-6">
                                    <div className="p-4 rounded-2xl bg-[#006747]/5 border border-[#006747]/20">
                                        <div className="flex items-center gap-2 mb-2">
                                            <TrendingUp className="w-4 h-4 text-[#006747]" />
                                            <span className="text-[10px] font-black text-white uppercase tracking-widest">High xG Conversion</span>
                                        </div>
                                    ...
                                    <div className="p-4 rounded-2xl bg-yellow-500/5 border border-yellow-500/20">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-[10px] font-black text-white uppercase tracking-widest">Awaiting Velocity Data</span>
                                        </div>
                                        <p className="text-[10px] text-white/50 leading-relaxed font-medium">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <Card className="glass border-red-500/20 bg-red-500/[0.02]">
                            <CardHeader className="border-b border-red-500/10 pb-4">
                                <CardTitle className="text-xs font-black text-white uppercase tracking-widest">Strategic substitution logic</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4 pt-6">
                                <p className="text-[10px] text-white/40 font-bold uppercase tracking-tighter leading-relaxed">
                                ...
                                <div className="bg-red-500/10 p-5 rounded-2xl border border-red-500/20 shadow-2xl">
                                    <span className="text-[10px] font-black text-red-500 uppercase tracking-widest block mb-3">Neural Analysis Parameters</span>
                                    <ul className="text-[10px] text-white/60 font-medium list-disc list-inside space-y-2 uppercase tracking-tighter">
                ...
                <TabsContent value="disciplinary" className="space-y-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <Card className="glass border-white/5">
                            <CardHeader className="border-b border-white/5 pb-4">
                                <CardTitle className="text-xs font-black text-white uppercase tracking-widest">Spatiotemporal Foul Intensity</CardTitle>
                            </CardHeader>
